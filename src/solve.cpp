    ...
    ui(new Ui::Solve)
{
    ...
    connect(ui->aBox, QOverload<double>::of(&QDoubleSpinBox::valueChanged), [=, this](double){ resolve(); });
    connect(ui->bBox, QOverload<double>::of(&QDoubleSpinBox::valueChanged), [=, this](double){ resolve(); });
    connect(ui->cBox, QOverload<double>::of(&QDoubleSpinBox::valueChanged), [=, this](double){ resolve(); });
